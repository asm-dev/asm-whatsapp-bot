...
(async function main() {
    try {
        ...
        const contactName = "// Enter your contact name here that you want to send messages to and make sure its on top of your contact";
        ...
        for (var i = 0; i < amountOfMessages; i++) {
            await page.evaluate(() => {
                const message = "I'm ASM Bot I've been created to FUCK your whatsapp 😈";
